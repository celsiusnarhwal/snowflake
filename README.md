...
| `SNOWFLAKE_ALLOWED_WEBFINGER_HOSTS` | String   | A comma-separated lists of hostnames allowed in `acct:` URIs sent to Snowflake's WebFinger endpoint. The endpoint will return an HTTP 404 error for URIs with hostnames not permitted by this setting.                                                                                                                 | N/A                       |
