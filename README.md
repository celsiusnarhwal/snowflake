...
| `preferred_username` | The username of the user's Discord account.                                                                                                                              | `openid`, `profile` |
| `name`               | The [display name](https://support.discord.com/hc/en-us/articles/12620128861463-New-Usernames-Display-Names#h_01GXPQABMYGEHGPRJJXJMPHF5C) of the user's Discord account. | `openid`, `profile` |
| `locale`             | The locale (i.e., chosen language setting) of the user's Discord account. See all possible locales [here](https://discord.com/developers/docs/reference#locales).        | `openid`, `profile` |
| `picture`            | The URL of the avatar of the user's Discord account.                                                                                                                     | `openid`, `profile` |
| `email`              | The email address associated with the user's Discord account.                                                                                                            | `openid`, `email`   |
| `email_verified`     | Whether the email address associated with the user's Discord account is verified.                                                                                        | `openid`, `email`   |
| `groups`             | A list of IDs of guilds the user is a member of.                                                                                                                         | `openid`, `groups`  |
