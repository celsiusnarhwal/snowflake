...
| `SNOWFLAKE_TREAT_LOOPBACK_AS_SECURE` | Boolean  | If `true`, Snowflake will consider loopback addresses (e.g., `localhost`) to be secure even if they don't use HTTPS.                                                                                                                                                                                                                                                                                  | `true`                    |
